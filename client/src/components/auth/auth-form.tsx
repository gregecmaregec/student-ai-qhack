    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <span className="hidden md:inline lg:inline">Continue with Google</span>
          <span className="inline sm:inline md:hidden">Google</span>
        </Button>
        ...
        >
          ...
          <span className="hidden md:inline lg:inline">Continue with Microsoft</span>
          <span className="inline sm:inline md:hidden">Microsoft</span>
        </Button>
      </div>
