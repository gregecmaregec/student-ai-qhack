    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <span className="inline sm:hidden md:hidden">Google</span>
          <span className="hidden md:inline lg:hidden">Google Sign In</span>
        </Button>
        ...
        >
          ...
          <span className="inline sm:hidden md:hidden">Microsoft</span>
          <span className="hidden md:inline lg:hidden">Microsoft Sign In</span>
        </Button>
      </div>
