    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <span className="inline sm:inline lg:hidden">Google</span>
        </Button>
        ...
        >
          ...
          <span className="hidden lg:inline">Continue with Microsoft</span>
          <span className="inline sm:inline lg:hidden">Microsoft</span>
        </Button>
      </div>
